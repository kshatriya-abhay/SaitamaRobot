...
ADD_CLEAN_BLUE_TEXT_HANDLER = DisableAbleCommandHandler("ignoreblue",
                                                        add_bluetext_ignore)
REMOVE_CLEAN_BLUE_TEXT_HANDLER = DisableAbleCommandHandler(
    "unignoreblue", remove_bluetext_ignore)
ADD_CLEAN_BLUE_TEXT_GLOBAL_HANDLER = DisableAbleCommandHandler(
...
LIST_CLEAN_BLUE_TEXT_HANDLER = DisableAbleCommandHandler(
